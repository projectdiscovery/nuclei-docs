...
## [Templates v8.4.2 - 26 July 2021](https://github.com/projectdiscovery/nuclei-templates/releases/tag/v8.4.2)
	...
	- cves/2021/CVE-2021-3377.yaml by @geeknik
	- cves/2021/CVE-2021-33221.yaml by @geeknik
	- cves/2021/CVE-2021-32820.yaml by @dhiyaneshDk
	- cves/2021/CVE-2021-31581.yaml by @geeknik
	- cves/2021/CVE-2021-31250.yaml by @geeknik
	- cves/2021/CVE-2021-31249.yaml by @geeknik
	- cves/2021/CVE-2021-26475.yaml by @geeknik
	- cves/2021/CVE-2021-24291.yaml by @geeknik
	- cves/2021/CVE-2021-23241.yaml by @daffainfo
	- cves/2021/CVE-2021-21479.yaml by @dwisiswant0
	- cves/2020/CVE-2020-9402.yaml by @geeknik
	- cves/2020/CVE-2020-8813.yaml by @gy741
	- cves/2020/CVE-2020-6207.yaml by @_generic_human_
	- cves/2020/CVE-2020-5307.yaml by @gy741
	- cves/2020/CVE-2020-35580.yaml by @daffainfo
	- cves/2020/CVE-2020-29227.yaml by @daffainfo
	- cves/2020/CVE-2020-28871.yaml by @gy741
	- cves/2020/CVE-2020-24949.yaml by @geeknik
	- cves/2020/CVE-2020-13117.yaml by @gy741
	- cves/2018/CVE-2018-2392.yaml by @_generic_human_
	- cves/2018/CVE-2018-20985.yaml by @daffainfo
	- cves/2018/CVE-2018-10822.yaml by @daffainfo
	- cves/2018/CVE-2018-1000600.yaml by @geeknik
	- cves/2016/CVE-2016-2004.yaml by @pussycat0x
	- cves/2016/CVE-2016-1000154.yaml by @daffainfo
	- cves/2016/CVE-2016-1000152.yaml by @daffainfo
	- cves/2016/CVE-2016-1000140.yaml by @daffainfo
	- cves/2016/CVE-2016-1000138.yaml by @daffainfo
	- cves/2016/CVE-2016-1000137.yaml by @daffainfo
	- cves/2016/CVE-2016-1000127.yaml by @daffainfo
	- cves/2016/CVE-2016-1000126.yaml by @daffainfo
	- cves/2016/CVE-2016-0957.yaml by @geeknik
	- cves/2014/CVE-2014-6308.yaml by @daffainfo
	- cves/2014/CVE-2014-2962.yaml by @daffainfo
	- cves/2014/CVE-2014-2323.yaml by @geeknik
	- cves/2013/CVE-2013-7240.yaml by @daffainfo
	- cves/2013/CVE-2013-5528.yaml by @daffainfo
	- cves/2012/CVE-2012-4889.yaml by @daffainfo
	- cves/2012/CVE-2012-1823.yaml by @pikpikcu
	- cves/2011/CVE-2011-3315.yaml by @daffainfo
	- cves/2010/CVE-2010-4231.yaml by @daffainfo
	- cves/2010/CVE-2010-2307.yaml by @daffainfo
	- cves/2009/CVE-2009-1872.yaml by @princechaddha
	- cves/2007/CVE-2007-0885.yaml by @geeknik
	- vulnerabilities/other/dedecms-carbuyaction-fileinclude.yaml by @pikpikcu
	- vulnerabilities/other/dedecms-membergroup-sqli.yaml by @pikpikcu
	- vulnerabilities/other/h3c-imc-rce.yaml by @pikpikcu
	- vulnerabilities/other/hiboss-rce.yaml by @pikpikcu
	- vulnerabilities/other/kevinlab-bems-backdoor.yaml by @gy741
	- vulnerabilities/other/kevinlab-bems-sqli.yaml by @gy741
	- vulnerabilities/other/magicflow-lfi.yaml by @gy741
	- vulnerabilities/other/netgear-wnap320-rce.yaml by @gy741
	- vulnerabilities/other/nginx-merge-slashes-path-traversal.yaml by @dhiyaneshDk
	- vulnerabilities/other/sangfor-edr-auth-bypass.yaml by @princechaddha
	- vulnerabilities/other/visual-tools-dvr-rce.yaml by @gy741
	- vulnerabilities/wordpress/easy-media-gallery-pro-listing.yaml by @pussycat0x
	- vulnerabilities/wordpress/wp-arforms-listing.yaml by @pussycat0x
	- vulnerabilities/wordpress/wp-email-subscribers-listing.yaml by @pussycat0x
	- vulnerabilities/wordpress/wp-idx-broker-platinum-listing.yaml by @pussycat0x
	- vulnerabilities/wordpress/wp-iwp-client-listing.yaml by @pussycat0x
	- vulnerabilities/wordpress/wp-sfwd-lms-listing.yaml by @pussycat0x
	- default-logins/apache/apache-superset-default-credentials.yaml by @dhiyaneshDK
	- default-logins/exacqvision/exacqvision-default-credentials.yaml by @ELSFA7110
	- default-logins/glpi/glpi-default-credential.yaml by @andysvints
	- default-logins/ibm/ibm-storage-default-credential.yaml by @madrobot
	- default-logins/iptime/iptime-default-login.yaml by @gy741
	- exposures/configs/appsec-yml-disclosure.yaml by @dhiyaneshDk
	- exposures/configs/dockerfile-hidden-disclosure.yaml by @dhiyaneshDk
	- exposures/configs/git-credentials-disclosure.yaml by @dhiyaneshDk
	- exposures/configs/github-workflows-disclosure.yaml by @dhiyaneshDk
	- exposures/configs/hp-ilo-serial-key-disclosure.yaml by @dhiyaneshDk
	- exposures/configs/kubernetes-kustomization-disclosure.yaml by @dhiyaneshDk
	- exposures/files/cold-fusion-cfcache-map.yaml by @geeknik
	- exposures/files/php-user-ini-disclosure.yaml by @dhiyaneshDk
	- exposures/files/putty-private-key-disclosure.yaml by @dhiyaneshDk
	- exposures/files/pyproject-disclosure.yaml by @dhiyaneshDk
	- exposures/files/ruby-on-rails-secret-token-disclosure.yaml by @dhiyaneshDk
	- exposures/files/sensitive-storage-data-exposure.yaml by @pussycat0x
	- exposures/files/snyk-ignore-file-disclosure.yaml by @dhiyaneshDk
	- exposures/files/thumbs-db-disclosure.yaml by @dhiyaneshDk
	- exposures/logs/development-logs.yaml by @geeknik
	- exposures/logs/production-logs.yaml by @geeknik
	- exposures/logs/roundcube-log-disclosure.yaml by @dhiyaneshDk
	- exposures/logs/wp-app-log.yaml by @geeknik
	- exposed-panels/pagespeed-global-admin.yaml by @geeknik
	- iot/kevinlab-device-detect.yaml by @gy741
	- iot/lutron-iot-default-login.yaml by @geeknik
	- iot/targa-camera-lfi.yaml by @gy741
	- iot/targa-camera-ssrf.yaml by @gy741
	- misconfiguration/clockwork-dashboard-exposure.yaml by @dhiyaneshDk
	- network/detect-addpac-voip-gateway.yaml by @geeknik
	- network/vnc-detect.yaml by @pussycat0x
	- technologies/adobe-coldfusion-detector-error.yaml by @philippedelteil
	- technologies/bedita-detect.yaml by @pikpikcu
	- technologies/chevereto-detect.yaml by @pikpikcu
	- technologies/dotclear-detect.yaml by @pikpikcu
	- technologies/linkerd-service-detect.yaml by @dudez
	- technologies/redcap-detector.yaml by @philippedelteil,@retr0
	- technologies/sceditor-detect.yaml by @pikpikcu
	- dns/detect-dangling-cname.yaml by @pdteam,@nytr0gen
	- exposed-panels/mantis-detect.yaml by @makyotox
	- workflows/phpmyadmin-workflow.yaml by @philippedelteil
